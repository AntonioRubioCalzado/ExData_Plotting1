...
#We now draw the last plot, first we change
#The configuration parameter to have 4 graphics in the same plot
...
plot(datetime, datos$Voltage, ylab="Voltage", type = "l")
...
plot(datetime,datos$Global_reactive_power, type = "l", xlab = "Global_reactive_power")
